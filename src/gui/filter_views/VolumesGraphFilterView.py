...
from graphs.VolumesGraph import draw_graph
from datetime import timedelta as td
import datetime as dt

class VolumesGraphFilterView:
    def __init__(self, root, frame):
        ...
        self.Regul_RB = Radiobutton(self.frame, text="Standartinis grafikas", variable=self.GraphTypeValue, value=1)
        self.Regul_RB.grid(row=8,column=1,padx=5, pady=10)

        self.Logo_RB = Radiobutton(self.frame, text="Logaritminė Y ašis", variable=self.GraphTypeValue, value=2)
        self.Logo_RB.grid(row=8,column=2,padx=5, pady=10)
